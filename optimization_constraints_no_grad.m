...
function [c, ceq] = optimization_constraints_no_grad(x, s)
...
%     final_state = [0.000000 0.853970 -0.000000 0.000026 -0.374286 0.001155 0.000026];
    ...
    c = [];
    ceq = [];
%     ceq = [pos(1,2) - 0.5125; vel(1,:)'];
    ceq = [pos(1,2) - 0.704951; pos(1,5)-(-0.225268); pos(1,7); vel(1,:)'];
...
%         % Evernote Trajectory Optimization
    ...
    ceq = [ceq; pos(s.nodes, 2)-0.8425; pos(1,7); vel(s.nodes,:)'];
